...
\date{14.\medspace 10.\medspace 2019}
...
\begin{itemize}
   ...
   smer skupine (npr.\medspace pedagoška matematika) ter število študentov v njej. Podobno kot pri
...
\begin{itemize}
   ...
   \item Predavanja posebne vrste (npr.\medspace vaje iz računalništva) se morajo izvajati v ustrezni predavalnici.
   \item Urnik mora zadoščati zastavljenemu časovnemu okvirju (npr.\medspace od sedmih zjutraj do osmih zvečer).
\end{itemize}
%
...
dodeljevanje t.i.\medspace prekrivanj. Če želi algoritem dodeliti predavanje določeni predavalnici,
...
V 2.\medspace poglavju bomo opisali postopek gradnje urnika, saj bomo podrobneje spoznali
...
V 1.\medspace poglavju smo izvedeli, da ročna izdela urnikov ni tako preprosta, kot bi si
...
\begin{enumerate}
   ...
   ki jo izvajamo na tem koraku (npr.\medspace zamenjava dveh srečanj).
...
spremembo (npr.\medspace zamenjava $\text{srečanja}_i$ in $\text{srečanja}_j$) sedaj shranimo v
